...
const Banner = () => {
  ...
  console.log(cmResourceArr);
  console.log("this is cm reousrce");
        ...
        <div className="row banner_row">
          <div className="col-lg-6 order-1 order-lg-0">
            <div className="bithu_v5_baner_left">
              <h2>
                BUILD & MINT YOUR EVERY PetZ NFT{" "}
              ...
              <div className="coin-info">
                <span>
                  Max 10 NFTs per wallet . Public Sale Price {pubicPrice} APT
                </span>
                <span>
                  PUBLIC SALE MINT IS LIVE ON{" "}
                  <span className="highlighted">2024-05-01 09:00:00 (EST)</span>
